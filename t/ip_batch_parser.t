...
my $single_batch_input = '192.0.0.1%2C192.0.0.2%2C192.0.0.3%2C192.0.0.4%2F30';
...
my @multi_batch_matches = ip_batch_parser::extract_ip_batches(
  '192.0.0.1%2C192.0.0.2%2F31%2C192.0.0.3%2C192.0.0.4%2C192.0.0.5%2C192.0.0.6'
);
is_deeply(
  \@multi_batch_matches,
  [
    '192.0.0.1%2C192.0.0.2%2F31%2C192.0.0.3%2C192.0.0.4%2C192.0.0.5',
    '192.0.0.6'
  ]
);
